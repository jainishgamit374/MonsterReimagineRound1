  ...
  return (
    <div className="w-full relative">
      ...
      <div className="max-w-screen-xl m-auto min-h-screen relative py-8">
        <div className="img-container w-full h-full grid grid-cols-2 md:grid-cols-3 gap-4 p-4">
          <div className="drop-shadow-2xl flex items-center justify-center rounded-xl  md:rounded-3xl border-1 md:border-2 bg-[#060B27] text-white">
            <h1 className="text-[2vw] sm:text-sm md:text-2xl py-4 md:py-8">⭐ Dive In To all Flavours</h1>
          </div>
          ...
          <div className="drop-shadow-2xl flex items-center justify-center  md:row-span-2 rounded-lg md:rounded-3xl overflow-hidden">
          ...
          <div className="drop-shadow-2xl flex items-center justify-center rounded-xl md:rounded-3xl border-1 md:border-2 bg-[#060B27] text-zinc-300">
            <h1 className="text-[2vw] gap-1 sm:text-sm md:text-2xl md:py-8 flex items-center md:gap-4">Over New Products <MdArrowOutward /></h1>
          </div>
        </div>
      </div>
    </div>
