      ...
      {arr.map((item, index) => {
        return (
          <div key={index} className="h-[25vh] md:h-[30vh] flex items-center gap-16 lg:gap-6 flex-shrink-0 w-full bg-[#2C4387] text-white relative -m-px">
            <h1 className="font-[Kajiro] kajiro text-[30vw] lg:text-[28vw] md:text-[10vw] lg:font-semibold">REDBULL</h1>
            ...
            <h1 className="hidden lg:block md:block font-[Kajiro] kajiro text-[30vw] lg:text-[28vw] md:text-[10vw] lg:font-semibold">REDBULL</h1>
